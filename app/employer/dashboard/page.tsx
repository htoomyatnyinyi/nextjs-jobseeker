...
const EmployerDashboard = async () => {
  ...
  // console.log(profile, jobPosts, applications);

  return (
    <div>
      <h1>Employer Dashboard</h1>
      <div className="p-2 m-1 border-b-4 ">
        <div>{profile?.companyName || "No Company Profile"}</div>
        <div>Job Posts: {jobPosts.length}</div>
      ...
      <div className="p-2 m-1 border-b-4 ">
        {applications.map((app) => (
          <div
            key={app.id}
            className="p-2 m-1 text-green-500 hover:text-pink-400"
          >
            {app.jobSeekerProfile.fullName} applied for {app.jobPost.title}
          </div>
        ))}
      </div>
      <div className="p-2 m-1 border-b-4 ">
...
//   });
//   // may be not necessary because we already setup in middleware.
...
//                     <Button size="sm" variant="ghost" asChild>
//                       <Link
//                         href={`/employer/dashboard/job-applications/${app.id}`}
//                       >
...
//             <Button asChild variant="ghost" className="w-full mt-4">
//               <Link href="/employer/dashboard/job-applications">
...
// const DialogCard = ({ info }: { info: any }) => {
//   // console.log(info, "dialog");
//   // const [state, action, pending] = useActionState();
//   return (
//     <div className="p-2 m-1 text-amber-300">
//       <Dialog>
//         <form>
...
//               <DialogDescription>
//                 Make changes to your status here. Click save when you&apos;re
//                 done.
//               </DialogDescription>
//             </DialogHeader>

const page = () => {
  return (
    <div>
      <h1>profile page</h1>
      <p>Not use any more.</p>
      <p>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aspernatur
        autem natus temporibus laborum accusamus dicta ut mollitia deserunt
        consequatur maiores, cupiditate officiis, eligendi fuga vitae.
        Cupiditate magni ratione cum vitae.
      </p>
    </div>
  );
};
